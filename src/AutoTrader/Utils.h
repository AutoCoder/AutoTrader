...
namespace Transmission{
	...
	public:
		...
		static void SendAccountInfo(const std::shared_ptr<Transmission::socket_session>& session, double blance, int position, const std::string& instrument, int currentPrice);
