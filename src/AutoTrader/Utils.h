...
namespace Transmission{
	...
	public:
		...
		static void SendDealInfo(const SockSessionSP& session, TradeEventType type, const std::string& instrument, int direction, char combOffsetFlag, int price, int vol, char*  orderRef, long long timestamp);
