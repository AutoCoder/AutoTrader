...
namespace Transmission{
	...
	public:
		...
		static void SendDealInfo(const std::shared_ptr<Transmission::socket_session>& session, TradeEventType type, int direction, char combOffsetFlag, int price, int vol, char*  orderRef, long long timestamp);
